...
from dimalib.nn.pretrained.custom_layers.scale_layer import Scale


def densenet161_model(nb_dense_block=4, growth_rate=48, reduction=0.5, dropout_rate=0.0, weight_decay=1e-4, num_classes=None):
    '''
